...
- Demonstrar as funcionalidades do aplicativo mobile
...
```bash
git clone https://github.com/estevam5s/petcare-ai-apresentacao.git
...
|---------|-----|-----------|
| **🎥 Apresentação Live** | [petcareai-apresentacao.vercel.app](https://petcareai-apresentacao.vercel.app) | Apresentação interativa |
| **🌐 Site Oficial** | [petcareai.vercel.app](https://petcareai.vercel.app) | Site institucional |
| **📱 Download APK** | [GitHub Releases](https://github.com/estevam5s/petcare-ai-app/releases) | APK do aplicativo |
| **💻 Código Fonte Mobile** | [GitHub - Mobile App](https://github.com/estevam5s/petcare-ai) | Repositório do app |
| **🎨 Código Fonte Web** | [GitHub - Apresentação](https://github.com/estevam5s/petcare-ai-apresentacao) | Este repositório |
...
ACESSO, USO OU DISTRIBUIÇÃO NÃO AUTORIZADOS CONSTITUEM VIOLAÇÃO 
DE DIREITOS AUTORAIS E PODEM RESULTAR EM AÇÃO CIVIL E CRIMINAL.
```
...
<div align="center">
  <h3>🚀 Feito com ❤️ e muita ☕ por <a href="https://estevamsouza.com.br">Estevam Souza</a></h3>
  
  <p>
    <strong>PetCare AI</strong> - Revolucionando o cuidado com pets através da tecnologia
  </p>
  
  <img src="public/logo.png" alt="PetCare AI" width="100" style="border-radius: 15px; margin-top: 20px;">
</div>
